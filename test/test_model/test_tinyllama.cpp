...
TEST_F(TinyLlamaTest, WeightValueCheck) {
    ...
    std::vector<float> expected_weights = {6.288290023803711e-06f, 4.351139068603516e-06f,
                                           4.32133674621582e-06f, 9.655952453613281e-06f,
    ...
    for (size_t i = 0; i < expected_weights.size(); ++i) {
        ...
        LOG(INFO) << "Idx " << i << ": Actual=" << weights[i]
